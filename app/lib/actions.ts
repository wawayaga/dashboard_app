//this line converts every function in this file into a Server Action, that can be called from the Client or the Server.
'use server';
...
export async function createInvoice(prevState: State, formData: FormData){
  ...
  // This will help handle validation more gracefully without having put this logic inside the try/catch block.
    ...
    console.log(`validated fields is ${validatedFields}`);
    console.log(`validated fields errors is ${validatedFields.error}`);
